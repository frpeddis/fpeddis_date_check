...
if check_button:
    ...
    if selected_day_of_week == day_of_week:
        ...
        if selected_date:
            ...
            st.write(":point_right: Remainder after dividing the Magic Sum ", sbt, "  by 7 -> :point_right:", f"<span style='font-size:22px; font-weight:bold;'>{remainder}</span>", :point_left:,unsafe_allow_html=True)
